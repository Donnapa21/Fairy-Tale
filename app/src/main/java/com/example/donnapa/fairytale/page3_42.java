...
public class page3_42 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.page3_42);

        //เล่านิทาน
        mediaPlayer = MediaPlayer.create(this, R.raw.scene3_42);
...
//                //button_close
        ...
        final Intent a = new Intent(this, scene3_4.class);
