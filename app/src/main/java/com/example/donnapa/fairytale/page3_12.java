...
public class page3_12 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.page3_12);

        //เล่านิทาน


        mediaPlayer = MediaPlayer.create(this, R.raw.scene3_12);
...
//                //button_close
        ...
        final Intent a = new Intent(this, scene3_1.class);
